...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @elseif(auth()->user()->role === \App\Models\User::ROLE_TECHNICIAN)
                        <x-nav-link :href="route('technician.dashboard')" :active="request()->routeIs('technician.dashboard')" wire:navigate>
                            {{ __('Dashboard') }}
                        </x-nav-link>
                        <x-nav-link :href="route('technician.equipment.index')" :active="request()->routeIs('technician.equipment.*')" wire:navigate>
                            {{ __('Equipment') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @elseif(auth()->user()->role === \App\Models\User::ROLE_TECHNICIAN)
                <x-responsive-nav-link :href="route('technician.dashboard')" :active="request()->routeIs('technician.dashboard')" wire:navigate>
                    {{ __('Dashboard') }}
                </x-responsive-nav-link>
                <x-responsive-nav-link :href="route('technician.equipment.index')" :active="request()->routeIs('technician.equipment.*')" wire:navigate>
                    {{ __('Equipment') }}
                </x-responsive-nav-link>
