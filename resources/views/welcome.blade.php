...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>PC Maintenance System - Manage Your ICT Infrastructure</title>
    ...
    <body class="bg-gradient-to-br from-slate-50 to-blue-50 dark:from-gray-900 dark:to-slate-800 text-gray-900 dark:text-gray-100 min-h-screen">
        <!-- Header -->
                ...
                <div class="flex justify-between items-center h-16">
                    ...
                    @if (Route::has('login'))
                        <nav class="flex items-center gap-4">
                            @auth
                                <a href="{{ url('/dashboard') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-all duration-200 shadow-sm hover:shadow-md">
                            ...
                            @else
                                ...
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-lg transition-all duration-200 shadow-sm hover:shadow-md">
                                        Get Started
                                    </a>
                                @endif
                            @endauth
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center">
                        @if (Route::has('login'))
                            ...
                            @else
                                ...
                                @if (Route::has('register'))
                                    <a href="{{ route('register') }}" class="inline-flex items-center justify-center px-8 py-3 border-2 border-indigo-600 dark:border-indigo-400 text-base font-medium rounded-lg text-indigo-600 dark:text-indigo-400 bg-transparent hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-all duration-200">
                                        Create Account
                                    </a>
                                @endif
                            @endauth
        ...
        <div class="py-20 bg-white dark:bg-gray-900">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <!-- Feature 1 -->
                    <div class="bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-gray-800 dark:to-gray-700 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                        <div class="w-12 h-12 bg-indigo-600 rounded-lg flex items-center justify-center mb-4">
                            <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                            </svg>
                        </div>
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Equipment Tracking</h3>
                        <p class="text-gray-600 dark:text-gray-300">Track PCs, accessories, and network devices with detailed specifications, status, and location information.</p>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-gray-800 dark:to-gray-700 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Technician Management</h3>
                        <p class="text-gray-600 dark:text-gray-300">Manage technicians, assign tasks, and monitor availability status for optimal resource allocation.</p>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-gray-800 dark:to-gray-700 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Service Requests</h3>
                        <p class="text-gray-600 dark:text-gray-300">Handle ICT service requests from employees with automated assignment and real-time status tracking.</p>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-gray-800 dark:to-gray-700 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Status Reports</h3>
                        <p class="text-gray-600 dark:text-gray-300">Generate detailed reports on equipment status, categorized by working, damaged, or needs replacement.</p>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-gray-800 dark:to-gray-700 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">Location Tracking</h3>
                        <p class="text-gray-600 dark:text-gray-300">Track equipment across different locations including labs, offices, and departments.</p>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-indigo-50 to-blue-50 dark:from-gray-800 dark:to-gray-700 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                        ...
                        <p class="text-gray-600 dark:text-gray-300">Comprehensive admin panel with analytics, equipment overview, and technician performance metrics.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <footer class="bg-gray-900 dark:bg-black text-gray-300 py-12">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div>
                        <h3 class="text-white font-semibold text-lg mb-4">PC Maintenance System</h3>
                        <p class="text-gray-400">Streamlining ICT infrastructure management for modern organizations.</p>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-400">Need help? Contact your system administrator.</p>
                    </div>
                </div>
                <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                    <p>&copy; {{ date('Y') }} PC Maintenance System. All rights reserved.</p>
                </div>
            </div>
        </footer>
